...
import com.example.app.data.repository.RoomAnnouncementRepository;
import com.example.app.data.repository.RoomEventRepository;
import com.example.app.data.repository.RoomHymnRepository;
import com.example.app.data.repository.RoomReflectionRepository;
import com.example.app.data.repository.RoomSermonRepository;
...
public class ContentDataSeeder {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Context appContext = systemContext.createPackageContext("com.example.app", Context.CONTEXT_INCLUDE_CODE | Context.CONTEXT_IGNORE_SECURITY);
