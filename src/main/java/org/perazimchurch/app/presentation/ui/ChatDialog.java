...
import org.perazimchurch.app.domain.repository.MessageRepository;
...
public class ChatDialog extends Dialog {
    ...
    private void confirmBlockMember() {
        ...
        builder.setPositiveButton("Block", (dialog, which) -> {
            try {
                org.perazimchurch.app.community.privacy.CommunityPrivacyHelper.blockAndReport(connectionRepository, currentUserId, peerId, "User blocked via direct chat");
    ...
    private void sendMessage() {
        ...
        if (!org.perazimchurch.app.community.privacy.CommunityPrivacyHelper.canMessage(connectionRepository, currentUserId, peerId)) {
